...
import useBorderSelectStyles from "./borderSelect.styles.js";
...
const BorderSelect = () => {
    ...
    const iconComponent = (props) => {
        return ( <
            ExpandMoreIcon className = {
                props.className + " " + borderSelectClasses.icon
            }
            />
        );
    };
    ...
    return ( <
        ...
        /InputLabel>{" "} <
        Select disableUnderline classes = {
            {
